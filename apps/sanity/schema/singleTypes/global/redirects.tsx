              ...
              return {
                ...
                media: () => (
                  <Tooltip
                    content={
                      <Box padding={1}>
                        <Text size={1}>{isPermanent ? '🔒 Permanent' : '🔄 Temporary'}</Text>
                      </Box>
                    }
                    placement='top'
                    portal
        ...
        Rule.custom(value => {
          ...
          try {
            ...
            for (const redirect of parsed) {
              ...
              if (!redirect.source.startsWith('/')) return 'Source paths must start with a forward slash (/)';
              ...
              if (!redirect.destination.startsWith('/')) return 'Destination paths must start with a forward slash (/)';
